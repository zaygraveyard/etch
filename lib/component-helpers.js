...
function renderComponent(component) {
  ...
  if (Array.isArray(virtualNode)) {
    virtualNode = {tag: Fragment, children: virtualNode}
  }
  return virtualNode
}
...
export function initialize(component) {
  ...
  const virtualNode = renderComponent(component)

  component.refs = {}
  component.virtualNode = virtualNode
  component.element = render(virtualNode, {
...
export function updateSync (component, replaceNode=true) {
  ...
  const newVirtualNode = renderComponent(component)
...
export function destroySync (component, removeNode=true) {
  ...
  if (syncDestructionsInProgressCounter === 1 && removeNode && component.element.parentNode) {
